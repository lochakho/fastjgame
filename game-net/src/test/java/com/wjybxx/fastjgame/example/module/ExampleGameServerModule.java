...
import com.wjybxx.fastjgame.example.world.ExampleGameServerWorld;
...
public class ExampleGameServerModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(WorldInfoMrg.class).to(ExampleGameServerInfoMrg.class).in(Singleton.class);
        bind(World.class).to(ExampleGameServerWorld.class).in(Singleton.class);
    }
}
